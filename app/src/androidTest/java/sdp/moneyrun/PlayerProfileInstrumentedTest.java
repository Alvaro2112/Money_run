...
public class PlayerProfileInstrumentedTest {
    ...
    @Test
    public void activityOpensCorrectly() {

        //assertEquals(Lifecycle.State.RESUMED, testRuleProfile.getScenario().getState());

            //onView(withId(R.id.go_to_profile_button)).perform(click());
